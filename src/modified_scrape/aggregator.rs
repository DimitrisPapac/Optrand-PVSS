...
impl<E, SSIG> PVSSAggregator<E, SSIG>   // <E, SPOK, SSIG>
where
	E: PairingEngine,
        SSIG: BatchVerifiableSignatureScheme<PublicKey = E::G1Affine, Secret = Scalar<E>>,   // NOTE: might make sense to switch to projective coordinates
	<E as PairingEngine>::G2Affine: AddAssign
{
    ...
    // Note: Invoke only before reconstruction.???
