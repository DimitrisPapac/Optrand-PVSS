...
Written purely in Rust and harnessing the power of real-world Crypto such as the Arkworks ecosystem for elliptic curve arithmetic and EdDSA ([dalek](https://github.com/dalek-cryptography/ed25519-dalek)) for signing NIZK proofs,
